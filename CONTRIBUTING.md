...
# Contribute to Ory integrations<!-- omit in toc -->
...
_Please note_: We take Ory integrations's security and our users' trust very
seriously. If you believe you have found a security issue in Ory integrations,
...
won't clash with Ory integrations's direction. A great way to do this is via
[Ory integrations Discussions](https://github.com/orgs/ory/discussions) or the
[Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/integrations/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory integrations?](#communication)
...
- I want to talk to other Ory integrations users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  integrations. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/integrations)

- I would like updates about new versions of Ory integrations.
...
[list of good first issues](https://github.com/ory/integrations/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  integrations. Github stars help the project gain visibility and stand out.
...
- **Help with open issues.** We have a lot of open issues for Ory integrations
...
Check out
[Ory integrations Discussions](https://github.com/orgs/ory/discussions). This is
...
If you want to receive regular notifications about updates to Ory integrations,
...
before getting started to ensure your work is consistent with Ory integrations's
...
[Contributor License Agreement](https://cla-assistant.io/ory/integrations).
...
git clone git@github.com:ory/ory/integrations.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/integrations.git
